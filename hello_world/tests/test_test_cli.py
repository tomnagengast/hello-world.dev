...
from hello_world.cli.test_cli import cli, get_provider_list, format_provider_output, TestCLIError
...
class TestErrorHandling:
    ...
    def test_config_file_not_found(self):
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ['list-providers', '--config', '/nonexistent/file.json'])
