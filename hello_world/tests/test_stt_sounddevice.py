...
class TestInterruptionHandler(unittest.TestCase):
    ...
    def test_voice_activity_stats(self):
        ...
        expected_keys = [
            'is_voice_active', 'last_voice_time', 'silence_duration_ms',
            'is_silence', 'noise_floor', 'dynamic_threshold', 'recent_voice_ratio'
        ]
...
class TestWhisperKitProvider(unittest.TestCase):
    ...
    def test_get_status(self):
        ...
        expected_keys = [
            'provider', 'model', 'is_running', 'is_recording', 'process_alive',
            'audio_stream_active', 'vad_enabled', 'compute_units', 'sample_rate',
            'block_duration', 'buffer_duration', 'audio_callback_count',
            'ring_buffer_available', 'audio_queue_size', 'vad_stats',
            'last_audio_time', 'processing_latency_ms'
        ]
