...
class TestClaudeProvider:
    ...
    def test_stream_response_timeout(self, mock_time, mock_popen):
        ...
        mock_process.stdin = Mock()
        mock_process.stdout = Mock()
        mock_process.stdout.readline.return_value = '{"type": "content_block_delta", "delta": {"text": "test"}}'
        mock_popen.return_value = mock_process
...
class TestGeminiProvider:
    ...
    @patch('google.generativeai.GenerativeModel')
    @patch('time.sleep')
    def test_stream_response_all_retries_fail(self, mock_sleep, mock_model_class, mock_configure):
