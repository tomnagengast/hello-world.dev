...
class TTSTestUtility:
    ...
    def _initialize_provider(self) -> None:
        ...
        try:
            ...
            self.provider = registry.get_tts_provider(
            ...
            raise RuntimeError(
                f"Failed to initialize TTS provider '{self.provider_name}': {str(e)}"
            )

    def run_tts_test(
        self, text: str, output_file: Optional[str] = None, output_format: str = "mp3"
    ) -> bool:
        """
    ...
    def _run_file_output_test(
        self, text: str, output_file: str, output_format: str
    ) -> bool:
